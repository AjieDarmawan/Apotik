            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('pelanggan')?>"><i class="fa fa-home"></i> Home </a>
                    
                  </li>
                 
                 
                  <li><a href="<?=base_url('pelanggan/obat')?>"><i class="fa fa-table"></i> Obat </a>
                  </li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?=base_url('pelanggan/gantipassword')?>"><i class="fa fa-windows"></i>Ganti Password </a>

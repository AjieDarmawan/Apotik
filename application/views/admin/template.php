...
<html lang="en">
  <head>
    ...
    <link href="<?=base_url()?>assets/gentelella/documentation/jquery.hashchange.min.js" rel="stylesheet">
    <link href="<?=base_url()?>assets/gentelella/documentation/jquery.validate.js" rel="stylesheet">
  </head>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Sistem informasi Apotik</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?=base_url('admin/karyawan')?>"><i class="fa fa-edit"></i>Karyawan</a></li>
                  <li><a href="<?=base_url('admin/pelanggan')?>"><i class="fa fa-child"></i>Pelanggan</a></li>

                  <li><a href="<?=base_url('admin/resep')?>"><i class="fa fa-desktop"></i>Resep </a>
                  </li>
                  <li><a href="<?=base_url('admin/obat')?>"><i class="fa fa-table"></i> Obat </a>
                  </li>
                  <li><a href="<?=base_url('admin/Penjualan')?>"><i class="fa fa-bar-chart-o"></i> Penjualan</a>
                    
                  </li>
                  
                  </li>
                  <li><a><i class="fa fa-file-text-o"></i>Transaksi<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                             <li><a href="<?=base_url('admin/Supplier')?>">Suppllier</a></li>
                             <li><a href="<?=base_url('admin/Supplay')?>">Supplay</a></li>
                             <li><a href="<?=base_url('admin/tp')?>">Transaksi Penjualan</a></li>
                             <li><a href="<?=base_url('admin/ts')?>">Transaksi Supplier</a></li>                  
                    </ul>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-file-text-o"></i>Laporan<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                             <li><a href="<?=base_url('admin/Laporan')?>">Grafik Penjualan</a></li>
                             <li><a href="<?=base_url('admin/LaporanS')?>">Grafik Supplier</a></li>
                  ...
                  <li><a href="<?=base_url('admin/gantipassword')?>"><i class="fa fa-windows"></i>Ganti Password </a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?=base_url()?>assets/gentelella/production/images/img.jpg" alt=""><?=$username?>

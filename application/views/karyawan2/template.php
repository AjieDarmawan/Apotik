            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('karyawan')?>"><i class="fa fa-home"></i> Home </a>
                    
                  </li>
                  <li><a href="<?=base_url('karyawan/karyawan')?>"><i class="fa fa-edit"></i>Karyawan</a></li>
                  <li><a href="<?=base_url('karyawan/pelanggan')?>"><i class="fa fa-child"></i>Pelanggan</a></li>

                  <li><a href="<?=base_url('karyawan/resep')?>"><i class="fa fa-desktop"></i>Resep </a>
                  </li>
                  <li><a href="<?=base_url('karyawan/obat')?>"><i class="fa fa-table"></i> Obat </a>
                  </li>
                  <li><a href="<?=base_url('karyawan/Penjualan')?>"><i class="fa fa-bar-chart-o"></i> Penjualan</a>
                 
                  
                  </li>
                  <li><a><i class="fa fa-file-text-o"></i>Transaksi<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                             <li><a href="<?=base_url('karyawan/Supplier')?>">Supplier</a></li>
                             <li><a href="<?=base_url('karyawan/Supplay')?>">Supplay</a></li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?=base_url('karyawan/gantipassword')?>"><i class="fa fa-windows"></i>Ganti Password </a>
